                          ...
                          @endphp
                                <a wire:click="getUser({{$user->id}})"  class="text-dark link">
                                    <li class="list-group-item">
                                        <img class="img-fluid avatar" src="{{asset('img/user.png')}}">
                ...
                <div class="card-footer">
                    <form wire:submit.prevent="SendMessage">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-success d-inline-block w-100"><i class="far fa-paper-plane"></i> Send</button>
                            </div>
                        </div>
                    </form>
                </div>
